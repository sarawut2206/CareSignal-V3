...
(function (g) {
  ...
  var TIER = {
    4: { nm: "เขียว · คงที่", cls: "t4", advice: "ทำแบบทดสอบซ้ำทุก 3 เดือน และคงการออกกำลังขาต่อไป" },
    3: { nm: "เหลือง · เฝ้าสังเกต", cls: "t3", advice: "ทำแบบทดสอบซ้ำใน 1 เดือน ปรับสิ่งแวดล้อมในบ้าน และเริ่มออกกำลังขาแบบง่าย" },
    2: { nm: "ส้ม · ถดถอย", cls: "t2", advice: "พาไปพบแพทย์หรือนักกายภาพบำบัดภายใน 2–4 สัปดาห์ พร้อมใบสรุปผล และวัดซ้ำใน 2 สัปดาห์" },
    1: { nm: "แดง · ต้องพบแพทย์", cls: "t1", advice: "พาไปพบแพทย์โดยเร็ว พร้อมใบสรุปผล และไม่ปล่อยให้อยู่คนเดียวในช่วงนี้" }
  };
